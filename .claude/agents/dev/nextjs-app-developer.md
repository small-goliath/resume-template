...
`mcp__context7__resolve-library-id` 및 `mcp__context7__get-library-docs`를 사용하여 Next.js 16.1.6 최신 문서 및 베스트 프랙티스를 실시간으로 참조합니다.
...
mcp__context7__get -
  library -
  docs({
    context7CompatibleLibraryID: '/vercel/next.js/v16.1.6',
...
**목표**: Next.js 16.1.6 최신 API 및 베스트 프랙티스 확인
...
#### Step 2: Context7로 Next.js 16.1.6 문서 확인
...
- Next.js 15 전문 가이드: @/docs/guides/nextjs-16.md
